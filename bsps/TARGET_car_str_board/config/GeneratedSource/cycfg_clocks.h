...
#define CLK_SPI_GD_CFG_ENABLED 1U

#if defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE)
#define CLK_SPI_GD_CFG_HW CYHAL_CLOCK_BLOCK_PERIPHERAL4_16_5BIT
#endif /* defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE) */

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define CLK_SPI_GD_CFG_HW CY_SYSCLK_DIV_16_5_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define CLK_SPI_GD_CFG_NUM 0U
#define CLK_SPI_GD_CFG_GRP_NUM ((4U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (CLK_SPI_GD_CFG_GRP_NUM)
#define CLK_SPI_GD_CFG_GRP_NUM CLK_SPI_GD_CFG_GRP_NUM
#endif /* !defined (CLK_SPI_GD_CFG_GRP_NUM) */

#define CLK_SPI_LED_ENABLED 1U

#if defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE)
#define CLK_SPI_LED_HW CYHAL_CLOCK_BLOCK_PERIPHERAL4_16_5BIT
#endif /* defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE) */

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define CLK_SPI_LED_HW CY_SYSCLK_DIV_16_5_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define CLK_SPI_LED_NUM 1U
#define CLK_SPI_LED_GRP_NUM ((4U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (CLK_SPI_LED_GRP_NUM)
#define CLK_SPI_LED_GRP_NUM CLK_SPI_LED_GRP_NUM
#endif /* !defined (CLK_SPI_LED_GRP_NUM) */

#define CLK_SPI_EC_ENABLED 1U

#if defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE)
#define CLK_SPI_EC_HW CYHAL_CLOCK_BLOCK_PERIPHERAL4_16_5BIT
#endif /* defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE) */

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define CLK_SPI_EC_HW CY_SYSCLK_DIV_16_5_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define CLK_SPI_EC_NUM 2U
#define CLK_SPI_EC_GRP_NUM ((4U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (CLK_SPI_EC_GRP_NUM)
...
#if defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE)
#define peri_0_group_6_div_16_5_0_HW CYHAL_CLOCK_BLOCK_PERIPHERAL6_16_5BIT
#endif /* defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE) */

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define peri_0_group_6_div_16_5_0_HW CY_SYSCLK_DIV_16_5_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define peri_0_group_6_div_16_5_0_NUM 0U
#define PERI_0_GROUP_6_DIV_16_5_0_GRP_NUM ((6U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (peri_0_group_6_div_16_5_0_GRP_NUM)
#define peri_0_group_6_div_16_5_0_GRP_NUM PERI_0_GROUP_6_DIV_16_5_0_GRP_NUM
#endif /* !defined (peri_0_group_6_div_16_5_0_GRP_NUM) */
