...
void init_cycfg_routing(void)
{
    ...
    Cy_TrigMux_Connect(TRIG_IN_MUX_10_TCPWM0_GRP1_OUT1_6, TRIG_OUT_MUX_10_TCPWM0_TR_IN13, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_11_HSIOM_TR_OUT0, TRIG_OUT_MUX_11_TCPWM0_GRP0_CNT2_TR3_IN, false, TRIGGER_TYPE_LEVEL);
    ...
    Cy_TrigMux_Connect(TRIG_IN_MUX_12_TCPWM0_GRP0_OUT0_3, TRIG_OUT_MUX_12_TCPWM0_GRP0_CNT2_TR4_IN, false, TRIGGER_TYPE_LEVEL);
    ...
    Cy_TrigMux_Connect(TRIG_IN_MUX_14_TCPWM0_GRP0_OUT1_2, TRIG_OUT_MUX_14_PASS_TR_A_IN2, false, TRIGGER_TYPE_LEVEL);
    ...
    Cy_TrigMux_Connect(TRIG_IN_MUX_2_TCPWM0_GRP0_LINE_2, TRIG_OUT_MUX_2_HSIOM_TR_IO_OUTPUT10, false, TRIGGER_TYPE_LEVEL);
