...
{
    Cy_TrigMux_Connect(TRIG_IN_MUX_0_SCB_RX1, TRIG_OUT_MUX_0_PDMA0_TR_IN15, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_0_SCB_RX3, TRIG_OUT_MUX_0_PDMA0_TR_IN14, false, TRIGGER_TYPE_LEVEL);
    ...
    Cy_TrigMux_Connect(TRIG_IN_MUX_12_TCPWM0_GRP0_OUT0_3, TRIG_OUT_MUX_12_TCPWM0_GRP0_CNT1_TR4_IN, false, TRIGGER_TYPE_LEVEL);
    ...
    Cy_TrigMux_Connect(TRIG_IN_MUX_12_TCPWM0_GRP1_OUT0_6, TRIG_OUT_MUX_12_TCPWM0_GRP2_CNT0_TR4_IN, false, TRIGGER_TYPE_LEVEL);
    ...
    Cy_TrigMux_Connect(TRIG_IN_MUX_12_TCPWM0_GRP1_OUT0_7, TRIG_OUT_MUX_12_TCPWM0_GRP2_CNT1_TR4_IN, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_14_TCPWM0_GRP0_OUT1_0, TRIG_OUT_MUX_14_PASS_TR_A_IN7, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_14_TCPWM0_GRP0_OUT1_1, TRIG_OUT_MUX_14_PASS_TR_A_IN2, false, TRIGGER_TYPE_LEVEL);
    ...
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_0, TRIG_OUT_MUX_1_PDMA1_TR_IN0, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_0, TRIG_OUT_MUX_1_PDMA1_TR_IN1, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_0, TRIG_OUT_MUX_1_PDMA1_TR_IN2, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_0, TRIG_OUT_MUX_1_PDMA1_TR_IN6, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_0, TRIG_OUT_MUX_1_PDMA1_TR_IN7, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_0, TRIG_OUT_MUX_1_PDMA1_TR_IN8, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_3, TRIG_OUT_MUX_1_PDMA1_TR_IN10, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_3, TRIG_OUT_MUX_1_PDMA1_TR_IN11, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_3, TRIG_OUT_MUX_1_PDMA1_TR_IN3, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_3, TRIG_OUT_MUX_1_PDMA1_TR_IN4, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_3, TRIG_OUT_MUX_1_PDMA1_TR_IN5, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_1_TCPWM0_GRP1_OUT0_3, TRIG_OUT_MUX_1_PDMA1_TR_IN9, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_2_TCPWM0_GRP0_LINE_1, TRIG_OUT_MUX_2_HSIOM_TR_IO_OUTPUT11, false, TRIGGER_TYPE_LEVEL);
