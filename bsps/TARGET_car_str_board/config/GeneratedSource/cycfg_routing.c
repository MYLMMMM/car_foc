...
{
    Cy_TrigMux_Connect(TRIG_IN_MUX_0_SCB_RX2, TRIG_OUT_MUX_0_PDMA0_TR_IN15, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_0_SCB_RX3, TRIG_OUT_MUX_0_PDMA0_TR_IN14, false, TRIGGER_TYPE_LEVEL);
    Cy_TrigMux_Connect(TRIG_IN_MUX_11_HSIOM_TR_OUT0, TRIG_OUT_MUX_11_TCPWM0_GRP0_CNT1_TR3_IN, false, TRIGGER_TYPE_LEVEL);
