...
#define CY_CFG_SYSCLK_ECO_GPIO_IN_PRT GPIO_PRT1
#define CY_CFG_SYSCLK_ECO_GPIO_IN_PIN 0
#define CY_CFG_SYSCLK_ECO_GPIO_OUT_PRT GPIO_PRT1
...
#define CY_CFG_SYSCLK_FLL_REFDIV 75U
...
#define CY_CFG_SYSCLK_CLKHF1_FREQ_MHZ 120UL
#define CY_CFG_SYSCLK_CLKHF1_CLKPATH CY_SYSCLK_CLKHF_IN_CLKPATH2
#define CY_CFG_SYSCLK_CLKHF2_ENABLED 1
#define CY_CFG_SYSCLK_CLKHF2_DIVIDER CY_SYSCLK_CLKHF_DIVIDE_BY_3
...
#define CY_CFG_SYSCLK_CLKHF4_FREQ_MHZ 120UL
...
__STATIC_INLINE void Cy_SysClk_EcoInit(void)
{
    (void)Cy_GPIO_Pin_FastInit(GPIO_PRT1, 0, CY_GPIO_DM_ANALOG, 0UL, HSIOM_SEL_GPIO);
    (void)Cy_GPIO_Pin_FastInit(GPIO_PRT1, 1, CY_GPIO_DM_ANALOG, 0UL, HSIOM_SEL_GPIO);
...
__STATIC_INLINE void Cy_SysClk_ClkHf2Init(void)
{
    ...
    Cy_SysClk_ClkHfSetDivider(CY_CFG_SYSCLK_CLKHF2, CY_SYSCLK_CLKHF_DIVIDE_BY_3);
