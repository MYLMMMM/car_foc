...
#define CY_CFG_SYSCLK_EXTCLK_GPIO_PRT GPIO_PRT0
#define CY_CFG_SYSCLK_EXTCLK_GPIO_PIN 0
#define CY_CFG_SYSCLK_EXTCLK_GPIO_HSIOM P0_0_SRSS_EXT_CLK
...
#define CY_CFG_SYSCLK_CLKPATH2_SOURCE CY_SYSCLK_CLKPATH_IN_EXT
#define CY_CFG_SYSCLK_CLKPATH3_ENABLED 1
#define CY_CFG_SYSCLK_CLKPATH3_SOURCE CY_SYSCLK_CLKPATH_IN_EXT
...
__STATIC_INLINE void Cy_SysClk_ExtClkInit(void)
{
    (void)Cy_GPIO_Pin_SecFastInit(GPIO_PRT0, 0, CY_GPIO_DM_HIGHZ, 0UL, P0_0_SRSS_EXT_CLK);
