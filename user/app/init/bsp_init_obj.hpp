...
foc_motor_datastructure_config foc_motor_datastructure_A_config =
{
    ...
    .vbus_divider_ratio = 6.83f,
    .shunt_resistance = 0.010f,
    .current_sense_gain = 40.0f,

    .encoder_cpr = 65535,
    .pole_pairs = 7,
    .theta_elec_offset = -3.353933012f,

    .pid_d_kp = 0.37f,
    .pid_d_ki = 0.57f,
    .pid_d_kd = 0.0f,
    .pid_d_integral_limit = 4.2f,
    .pid_q_kp = 0.37f,
    .pid_q_ki = 0.57f,
    .pid_q_kd = 0.0f,
    .pid_q_integral_limit = 4.2f,
    .pid_speed_kp = 0.18f,//
    .pid_speed_ki = 0.025f,//
    .pid_speed_kd = 0.0f,
    .pid_speed_integral_limit = 4.5f,
    .speed_lpf_fc = 200.0f,
    .speed_reverse = false,
    .speed_target_max = 125.0f,
    .speed_target_slope = 400.0f,//
...
foc_motor_datastructure_config foc_motor_datastructure_B_config =
{
    ...
    .encoder_cpr = 65535,
    .pole_pairs = 7,
    .theta_elec_offset = -6.0961086442f,
